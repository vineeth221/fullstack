                  ...
                  <div className="faq-item-1 mb-6">
                    ...
                    {isAnswerVisible('ans-2') && (
                      <p id="ans-2" className="faq-item-ans">
                        Innovative and functional kitchen solutions tailored to your needs.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="faq-item-1 mb-6">
                    ...
                    {isAnswerVisible('ans-3') && (
                      <p id="ans-3" className="faq-item-ans">
                        Customizable modular interior designs for a modern home.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="faq-item-1 mb-6">
                    ...
                    {isAnswerVisible('ans-4') && (
                      <p id="ans-4" className="faq-item-ans">
                        Enhance your home ambiance with our exquisite lighting solutions.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="faq-item-1 mb-6">
                    ...
                    {isAnswerVisible('ans-5') && (
                      <p id="ans-5" className="faq-item-ans">
                        Unique wall decor options to add personality to your space.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="faq-item-1 mb-6">
                    ...
                    {isAnswerVisible('ans-6') && (
                      <p id="ans-6" className="faq-item-ans">
                        Bespoke furniture designed to fit your style and needs.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="faq-item-1 mb-6">
                    ...
                    {isAnswerVisible('ans-9') && (
                      <p id="ans-9" className="faq-item-ans">
                        Discuss your vision and requirements with our expert designers.
                      </p>
                    )}
                  </div>
                  ...
                  <div className="faq-item-1 mb-6">
                    ...
                    {isAnswerVisible('ans-10') && (
                      <p id="ans-10" className="faq-item-ans">
                        Creating detailed designs and selecting materials and finishes.
                      </p>
                    )}
                  </div>
